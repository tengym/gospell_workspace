...
if has('multi_byte')        " If multibyte support is available and
  ...
  set fileencodings=utf-8,gb2312,gbk,gb18030 "ucs-bom,utf-8,chinese,latin1 " fileconding detection order
  if has("win32")
...
"""" for BASH_SUPPORT_Author
let g:BASH_AuthorName   = 'Yingman Ten'     
let g:BASH_AuthorRef    = 'Yingman'                         
let g:BASH_Email        = '137970703@qq.com'            
let g:BASH_Company      = '---'    

"""" for doxygen
let g:DoxygenToolkit_authorName="Yingman Ten <137970703@qq.com>" 
let g:DoxygenToolkit_versionTag="0.01_"
